		...
		def performAssembly():
			...
			while True:
				...
				if perform1stConsensusCalling == "yes" or perform1stConsensusCalling == "Yes":
					...
					os.system(installationDirectory+"/resources/lofreq call -q 30 -Q 30  -f finalScaffold_1_15001_f.txt -o output.vcf dedupped.bam")
					...
					os.system("python "+installationDirectory+"resources/getMajorAllele.py output.vcf output_filtered.vcf >null 2>&1")
					os.system(installationDirectory+"resources/vcf-sort output_filtered.vcf >temp.vcf ; mv temp.vcf output_filtered.vcf")
					os.system(installationDirectory+"resources/bgzip -c output_filtered.vcf > output_filtered.vcf.gz 2>null")
					os.system(installationDirectory+"resources/tabix output_filtered.vcf.gz >null 2>&1")
					self.logArea.configure(state='normal')
					self.logArea.insert(tk.END, "*  *  Creating consensus\n")
					self.logArea.see(tk.END)
					self.logArea.configure(state='disabled')
					self.logArea.update()
					os.system("cat finalScaffold_1_15001_f.txt | "+installationDirectory+"resources/bcftools consensus output_filtered.vcf.gz > finalScaffold_1_15001_f.txt_con.fasta 2>null")
					...
					self.logArea.configure(state='disabled')
					self.logArea.update()
					os.system("./extractSeqByRange.py finalScaffold.fasta finalScaffold 15001 "+str(assemblyLength -10000 )+" f")
					self.logArea.configure(state='normal')
					self.logArea.insert(tk.END, "*  *  Aligning reads to the assembly\n")
					self.logArea.see(tk.END)
					self.logArea.configure(state='disabled')
					...
					self.logArea.configure(state='disabled')
					self.logArea.update()
					os.system("java -jar -XX:ParallelGCThreads=16  "+installationDirectory+"resources/picard.jar MarkDuplicates I=rg_added_sorted.bam O=dedupped.bam  CREATE_INDEX=true VALIDATION_STRINGENCY=SILENT M=output.metrics >null 2>&1")
					self.logArea.configure(state='normal')
					self.logArea.insert(tk.END, "*  *  Calling polymorphisms\n")
					self.logArea.see(tk.END)
					self.logArea.configure(state='disabled')
					self.logArea.update()
					os.system("java -jar "+installationDirectory+"resources/picard.jar CreateSequenceDictionary R=finalScaffold_15001_"+str(assemblyLength -10000 )+"_f.txt >null 2>&1")
					os.system(installationDirectory+"resources/samtools faidx finalScaffold_15001_"+str(assemblyLength -10000 )+"_f.txt")
					os.system(installationDirectory+"/resources/lofreq call -q 30 -Q 30  -f finalScaffold_15001_"+str(assemblyLength -10000 )+"_f.txt -o output.vcf dedupped.bam")
					os.system("python "+installationDirectory+"resources/getMajorAllele.py output.vcf output_filtered.vcf >null 2>&1")
					os.system(installationDirectory+"resources/vcf-sort output_filtered.vcf >temp.vcf ; mv temp.vcf output_filtered.vcf")
					os.system(installationDirectory+"resources/bgzip -c output_filtered.vcf > output_filtered.vcf.gz 2>null")
					os.system(installationDirectory+"resources/tabix output_filtered.vcf.gz >null 2>&1")
					...
					self.logArea.configure(state='disabled')
					self.logArea.update()
					os.system("cat finalScaffold_15001_"+str(assemblyLength -10000 )+"_f.txt | "+installationDirectory+"resources/bcftools consensus output_filtered.vcf.gz > finalScaffold_15001_"+str(assemblyLength -10000 )+"_f.txt_con.fasta 2>null")
					...
					os.system(installationDirectory+"/resources/lofreq call -q 30 -Q 30  -f finalScaffold_"+str(assemblyLength - 10000 )+"_2000000_f.txt -o output.vcf dedupped.bam")
					os.system("python "+installationDirectory+"resources/getMajorAllele.py output.vcf output_filtered.vcf >null 2>&1")
					os.system(installationDirectory+"resources/vcf-sort output_filtered.vcf >temp.vcf ; mv temp.vcf output_filtered.vcf")
					os.system(installationDirectory+"resources/bgzip -c output_filtered.vcf > output_filtered.vcf.gz 2>null")
					os.system(installationDirectory+"resources/tabix output_filtered.vcf.gz >null 2>&1")
					...
					self.logArea.configure(state='disabled')
					self.logArea.update()
					os.system("cat finalScaffold_"+str(assemblyLength - 10000 )+"_2000000_f.txt | "+installationDirectory+"resources/bcftools consensus output_filtered.vcf.gz > finalScaffold_"+str(assemblyLength - 10000 )+"_2000000_f.txt_con.fasta 2>null")
				...
				if perform1stConsensusCalling == "yes" or perform1stConsensusCalling == "Yes":
					...
					os.system("cp "+installationDirectory+"assembly/scripts/joinConsensus.py ./6_createConsensus")
					os.system("cp "+installationDirectory+"assembly/scripts/hcmvConsensusCallPipeline ./6_createConsensus")
					...
					self.logArea.configure(state='disabled')
					self.logArea.update()
					os.system("./extractSeqByRange.py finalScaffold.fasta finalScaffold 1 15001 f")
					self.logArea.configure(state='normal')
					self.logArea.insert(tk.END, "*  *  Aligning reads to the assembly\n")
					self.logArea.see(tk.END)
					self.logArea.configure(state='disabled')
					...
					self.logArea.configure(state='disabled')
					self.logArea.update()
					os.system("java -jar "+installationDirectory+"resources/picard.jar CreateSequenceDictionary R=finalScaffold_1_15001_f.txt >null 2>&1")
					os.system(installationDirectory+"resources/samtools faidx finalScaffold_1_15001_f.txt")

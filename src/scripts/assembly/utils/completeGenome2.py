...
os.system(installationDirectory+"src/conda/bin/lastz "+genomeToComplete+" "+installationDirectory+"/data/merlinReference/sequence_trl.fasta --format=general > outputLastz")
...
os.system(installationDirectory+"/src/conda/bin/python joinScaffolds_careful.py join ../1_cleanReads/qualityFiltered_1.fq ../1_cleanReads/qualityFiltered_2.fq finalScaffold_1_2000_f.txt r finalScaffold_"+str(bestPos1)+"_"+str(bestPos2)+"_r.txt r "+installationDirectory+"  8")
...
os.system(installationDirectory+"src/conda/bin/lastz newGenome1.fasta "+installationDirectory+"data/merlinReference/sequence_irs.fasta --format=general > outputLastz")

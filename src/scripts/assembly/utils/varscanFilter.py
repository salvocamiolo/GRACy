...
while True:
	...
	if validate == 1:
		...
		if len(fields[3])>1:
			print("Validating deletion at position %s" %fields[1])
			print(refSeq[int(fields[1])-25:int(fields[1])-1]+"-"+fields[3]+"-"+refSeq[int(fields[1]):int(fields[1])+25-len(fields[3])])
			print(refSeq[int(fields[1])-25:int(fields[1])-1]+"-"+fields[4]+"-"+refSeq[int(fields[1]):int(fields[1])+25-len(fields[4])])

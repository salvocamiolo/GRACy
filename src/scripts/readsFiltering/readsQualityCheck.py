...
#*******************************************************
		...
		self.inputFolderLabel = tk.Label(top,highlightthickness=0,background="white",borderwidth=0,foreground="#204949")
		...
		self.recodingFileLabel = tk.Label(top,justify="left",highlightthickness=0,background="white",borderwidth=0,foreground="#204949")
		...
		self.recodingFileButton = tk.Button(top,command=openRecodingFile,background="#204949",foreground="white")
		self.recodingFileButton.place(x=340,y=160,height=30,width=100)
		self.recodingFileButton.configure(text="Open file")

		self.bowtieRefLabel = tk.Label(top,highlightthickness=0,background="white",borderwidth=0,foreground="#204949")
		...
		self.humanReferenceFileButton = tk.Button(top,command=openHumanReferenceFile,background="#204949",foreground="white")
		...
		self.adapter1Label = tk.Label(top,highlightthickness=0,background="white",borderwidth=0,foreground="#204949")
		...
		self.adapter2Label = tk.Label(top,highlightthickness=0,background="white",borderwidth=0,foreground="#204949")
		...
		self.numThreadsLabel = tk.Label(top,justify="left",highlightthickness=0,background="white",borderwidth=0,foreground="#204949")
		...
		self.tasksLabel = tk.Label(top,highlightthickness=0,background="white",borderwidth=0,foreground="#204949")
		...
		self.removeHumanCheckButton = tk.Checkbutton(top,variable=self.removeHumanChkValue,background="white",borderwidth=0,highlightthickness=0,bd=0,foreground="#204949")
		...
		self.removeAdaptersCheckButton = tk.Checkbutton(top,variable=self.removeAdaptersChkValue,background="white",borderwidth=0,highlightthickness=0,bd=0,foreground="#204949")
		...
		self.recodeSamplesCheckButton = tk.Checkbutton(top,variable=self.recodeSampleChkValue,background="white",borderwidth=0,highlightthickness=0,bd=0,foreground="#204949")
		...
		self.deduplicateCheckButton = tk.Checkbutton(top,variable=self.deduplicateChkValue,background="white",borderwidth=0,highlightthickness=0,bd=0,foreground="#204949")
		...
		self.al2RefCheckButton = tk.Checkbutton(top,variable=self.al2RefChkValue,background="white",borderwidth=0,highlightthickness=0,bd=0,foreground="#204949")
		...
		self.logTextLabel = tk.Label(top,highlightthickness=0,background="white",borderwidth=0,foreground="#204949")
		...
		self.runButton = tk.Button(top,command=runQualityCheck,background="#204949",foreground="white")
